...
<div id="topheader">
   ...
   <div class="topmenu_area">
    ...
    <div class="mid"><br>
	 <div class="tick_head"><span class="tick_head1" style="font-family: "Times New Roman", Times, serif">Delete Book</span></div><br><br>
     <table align="center" width="500" style="border:1px solid skyblue;">
	 <tr>
		<td><input type="text" name="bid" placeholder="Book id" required /></td>
	 </tr>
	 <tr>
		<td><button type="submit" name="btn-signup">Delete</button></td>
	</tr>
	 </table> 
    </div>
