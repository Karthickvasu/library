<html>
		...
		<form id="form1" name="form1" method="post" action="userpage1.php">
			...
			<table align="center" width="1000" style="border:1px solid #d2d2d2;">
 			...
 			<form action="userpage1.php" method="get" name="f" onSubmit="return training();">
 			<tr>
		...
		$sql ="SELECT bid,bname,aname,type,(vote/hitcount) as vote,hitcount FROM rank where type='$type'";
		mysql_select_db('php');
		...
		<center>
			<a href="userpage.php"  style="color: #009966; font-size:18px">BACK</a>
			<a href="userlogin.php"  style="color:#00FFFF; font-size:18px">LOGOUT</a>
			<a href="index.html" style="color:#0066CC; font-size:18px">HOME</a>
		</center>
		</body>
		</html>
